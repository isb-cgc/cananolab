...
# If you need to place your .env in another location, you must create a file named
# secure_path.env and place it in the Git Repository's root. This script will then
# look for it an apply that value as the location of the .env.
...
if [ ! -f "/home/vagrant/cananolab/secure_path.env" ]; then
    ...
    echo "value as its only entry and place it in the root directory (/home/vagrant/cananolab)."
