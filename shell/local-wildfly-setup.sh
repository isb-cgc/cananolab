...
cp -v ${CANANODIR}/artifacts/caNanoLab.war ${WILDFLY_HOME}/standalone/deployments
...
${JBOSS_CLI} --file=${CANANODIR}/artifacts/caNanoLab_modules.cli
echo "Setting up logging and data sources."
${JBOSS_CLI} --file=${CANANODIR}/artifacts/caNanoLab_setup.cli
...
${JBOSS_CLI} --file=${CANANODIR}/artifacts/caNanoLab_checks.cli
...
echo "Setup completed - stopping Wildfly"
