...
public class NanoBiopolymer extends NanomaterialEntity implements Serializable
{
	/**
	...
	**/
	...
	/**
	* Compares <code>obj</code> to its self and returns true if they both are same
	*
	* @param obj
	**/
	public boolean equals(Object obj)
	{
		if(obj instanceof NanoBiopolymer)
		{
			NanoBiopolymer c =(NanoBiopolymer)obj;
