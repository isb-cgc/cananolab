...
public class SynthesisCharacterization extends Characterization implements Serializable
{
	/**
	...
	**/
	...
	{
		if(obj instanceof SynthesisCharacterization) 
		{
			SynthesisCharacterization c =(SynthesisCharacterization)obj; 			 
