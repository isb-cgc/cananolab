...
public class ActivationMethod  implements Serializable
{
	...
	*/
	...
	/**
	* The result of having the sample undergo the process of activation.  (i.e. cleavage of a bond, release from quenching or encapsulation)
	**/
	...
	**/
	...
	/**
	* Something distinguishable as an identifiable class based on common qualities. Please refer to value domain NanoparticleActivationType.
	**/
