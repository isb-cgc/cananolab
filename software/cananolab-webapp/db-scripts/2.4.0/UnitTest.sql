...
) ENGINE=InnoDB AUTO_INCREMENT=189330 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT  IGNORE INTO `acl_entry` (`id`, `acl_object_identity`, `ace_order`, `sid`, `mask`, `granting`, `audit_success`, `audit_failure`) VALUES (1,1,0,3,1,1,0,0),(2,1,1,3,2,1,0,0),(3,1,2,3,8,1,0,0),(4,1,3,13,1,1,0,0),(5,1,4,13,2,1,0,0),(6,1,5,13,8,1,0,0),(7,1,6,14,1,1,0,0),(8,4,0,3,1,1,0,0),(9,4,1,3,2,1,0,0),(10,4,2,3,8,1,0,0),(11,4,3,13,1,1,0,0),(12,4,4,13,2,1,0,0),(13,4,5,13,8,1,0,0),(14,4,6,14,1,1,0,0),(15,1,7,12,1,1,0,0),(189281,9008,0,12,1,1,0,0),(189291,9010,0,3,1,1,0,0),(189292,9010,1,3,2,1,0,0),(189293,9010,2,3,8,1,0,0),(189294,9010,3,13,1,1,0,0),(189295,9010,4,13,2,1,0,0),(189296,9010,5,13,8,1,0,0),(189297,9010,6,14,1,1,0,0),(189307,9011,0,3,1,1,0,0),(189308,9011,1,3,2,1,0,0),(189309,9011,2,3,8,1,0,0),(189310,9011,3,13,1,1,0,0),(189311,9011,4,13,2,1,0,0),(189312,9011,5,13,8,1,0,0),(189313,9011,6,14,1,1,0,0),(189323,9012,0,3,1,1,0,0),(189324,9012,1,3,2,1,0,0),(189325,9012,2,3,8,1,0,0),(189326,9012,3,13,1,1,0,0),(189327,9012,4,13,2,1,0,0),(189328,9012,5,13,8,1,0,0),(189329,9012,6,14,1,1,0,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=9015 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT  IGNORE INTO `composing_element` (`composing_element_pk_id`, `element_type`, `nanomaterial_entity_pk_id`) VALUES (65732608,'monomer',65667072),(65732610,'coat',65667073),(65732611,'RNA',65667074),(65732612,'lipid',65667075),(65732613,'modifier',65667075);
...
INSERT  IGNORE INTO `composition` (`composition_pk_id`, `sample_pk_id`) VALUES (65699840,1000),(65699841,65634304),(65699842,65634305),(65699843,65634306);
...
INSERT  IGNORE INTO `datum` (`datum_pk_id`, `name`, `value`, `value_type`, `value_unit`, `created_by`, `created_date`, `finding_pk_id`, `file_pk_id`, `numberMod`) VALUES (66027520,'Col1Datum',3.0000000000,'number of replicates','number','canano_curator','2020-01-08 19:19:46',65994752,NULL,'='),(66027521,'Col1Datum',3.0000000000,'number of replicates','number','canano_curator','2020-01-08 19:21:26',65994752,NULL,'='),(66027522,'Col1Datum',3.0000000000,'number of replicates','number','canano_curator','2020-01-08 19:23:06',65994752,NULL,'=');
...
INSERT  IGNORE INTO `datum_condition` (`datum_pk_id`, `condition_pk_id`) VALUES (66027520,66060288),(66027521,66060289),(66027522,66060290);
...
INSERT  IGNORE INTO `experiment_condition` (`condition_pk_id`, `name`, `property`, `value`, `value_unit`, `value_type`, `created_by`, `created_date`) VALUES (1000,'Synthesis condition 1','','42','g','observed','canano_user','2019-12-06 12:15:00'),(66060288,'dilution factor','other','0.9','num','observed','canano_curator','2020-01-08 19:19:47'),(66060289,'dilution factor','other','0.8','num','observed','canano_curator','2020-01-08 19:21:27'),(66060290,'dilution factor','other','0.5','num','observed','canano_curator','2020-01-08 19:23:07');
...
INSERT  IGNORE INTO `experiment_config` (`experiment_config_pk_id`, `description`, `created_date`, `created_by`, `characterization_pk_id`, `technique_pk_id`) VALUES (65863680,'PCR description','2020-01-08 19:18:01','canano_curator',65961984,65896448);
...
INSERT  IGNORE INTO `experiment_config_instrument` (`experiment_config_pk_id`, `instrument_pk_id`) VALUES (65863680,65929216);
...
INSERT  IGNORE INTO `file` (`file_pk_id`, `file_name`, `file_uri`, `file_extension`, `created_by`, `created_date`, `title`, `description`, `comments`, `file_type`, `is_uri_external`) VALUES (1000,'NCIt_CTCAE_5.0','https://evs.nci.nih.gov/ftp1/CTCAE/CTCAE_5.0/NCIt_CTCAE_5.0.xlsx','xlsx','canano_curator','2019-12-06 12:15:00','Synthesis File','dummy row for testing of synthesis',NULL,'Excel',0),(1005,'NCIt_CTCAE_5.0','https://evs.nci.nih.gov/ftp1/CTCAE/CTCAE_5.0/NCIt_CTCAE_5.0.xlsx','xlsx','canano_curator','2019-08-28 00:00:00','Synthesis File','dummy row for testing of synthesis',NULL,'Excel',0);
...
INSERT  IGNORE INTO `finding` (`finding_pk_id`, `characterization_pk_id`, `created_by`, `created_date`) VALUES (65994752,65961984,'canano_curator','2020-01-08 19:19:46');
...
INSERT  IGNORE INTO `hibernate_unique_key` (`next_hi`) VALUES (2018);
...
INSERT  IGNORE INTO `nanomaterial_entity` (`nanomaterial_entity_pk_id`, `composition_pk_id`, `discriminator`, `description`, `created_by`, `created_date`) VALUES (65667072,65699840,'Biopolymer','Test sample','canano_curator','2020-01-08 19:11:47'),(65667073,65699841,'Fullerene','Full test','canano_curator','2020-01-08 19:14:54'),(65667074,65699842,'Liposome','Test liposome','canano_curator','2020-01-08 19:16:46'),(65667075,65699843,'OtherNanomaterialEntity','Metal example','canano_curator','2020-01-08 19:21:58');
...
INSERT  IGNORE INTO `other_nanomaterial_entity` (`other_nanomaterial_entity_pk_id`, `type`) VALUES (65667075,'metal particle');
...
INSERT  IGNORE INTO `protocol` (`protocol_pk_id`, `protocol_name`, `protocol_type`, `created_by`, `created_date`, `protocol_abbreviation`, `protocol_version`, `file_pk_id`) VALUES (1000,'Synthesis test protocol','synthesis','canano_curator','2019-12-06 12:15:00','SYN','1.0',1000),(1005,'Synthesis demo protocol','synthesis purification','canano_curator','2019-08-28 00:00:00','SYN','1.0',1005);
...
CREATE TABLE `purification_config` (
  ...
  KEY `FK_technique_TO_purification_config` (`technique_pk_id`),
...
INSERT  IGNORE INTO `synthesis_purification` (`synthesis_purification_pk_id`, `synthesis_pk_id`, `protocol_pk_id`, `type`, `method_name`, `design_method_description`, `created_by`, `created_date`, `yield`) VALUES (1000,1000,1000,'Interim Purification','Synthesis Purification Method 1','Test entry for synthesis purification','canano_user','2019-12-06 12:15:00',84.7000000000),(1005,1005,1005,'Interim Purification','Synthesis Purification Method 1','The AuNP solutions were then centrifuged using a Contifuge 17RS, Heraeus SEPATECH at 10,000 rpm for 90 min in 10 ml batches [28]. Of the supernatant, 9.9 ml was then decanted, leaving the AuNP pellet at the bottom of the centrifuge tube. The volume was then made back up to 10 ml by adding 9.9 ml of DI water and agitated. This centrifugal washing process was repeated again to remove any unattached PEG or other reactants.','canano_user','2019-08-28 00:00:00',NULL);
...
INSERT  IGNORE INTO `technique` (`technique_pk_id`, `type`, `abbreviation`, `created_date`, `created_by`) VALUES (1000,'Interim purification technique','InP','2019-12-06 12:15:00','safrant'),(1005,'centrifugal filtration',NULL,'2018-08-28 00:00:00','safrant'),(65896448,'polymerase chain reaction','PCR','2020-01-08 19:18:01','canano_curator');
