	...
	public void testSetup() {
		...
		Response res =
				...
				.body("fileTypes", hasItems("document","graph","image","movie","spread sheet","txt"))
						.when().get("http://192.168.1.16:8090/caNanoLab/rest/compositionFile/setup");
	...
	public void testEdit() {
		...
		Response res =
				...
				.body("type", equalToIgnoringCase("graph"))
						.when().get("http://192.168.1.16:8090/caNanoLab/rest/compositionFile/edit");
...
//				.when().post("http://192.168.1.16:8090/caNanoLab/rest/compositionFile/submit");
//		System.out.println(res.getBody().asString());
//
//		RestTestLoginUtil.logoutTest();
//		
