  ...
  .directive('navigation', function ($location) {
    ...
    var link = function ($scope, $element, $attrs) {
      ...
      $scope.edit = [{
        ...
        'url': '/editNanoMaterialEntity',
        'alternativeUrl': '/editComposition',
        'name': 'COMPOSITION'
      }, {
        'url': '/editFunctionalizingEntity',
        'alternativeUrl': '/editComposition',
        'name': 'COMPOSITION'
      }, {
        'url': '/editChemicalAssociation',
        'alternativeUrl': '/editComposition',
        'name': 'COMPOSITION'
      }, {
        'url': '/editCompositionFile',
        'alternativeUrl': '/editComposition',
        'name': 'COMPOSITION'
      }, {
        'url': '/editPublication',
      ...
      $scope.testClick = function (uri) {
        ...
        $location.path(uri).search({
          'sampleId': $location.search()['sampleId']
        }).replace();
      }
