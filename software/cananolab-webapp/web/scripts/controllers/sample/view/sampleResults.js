...
var app = angular.module('angularApp')
    .controller('SampleResultsCtrl', function (sampleService, navigationService, groupService, utilsService, $scope, $rootScope, $filter, ngTableParams, $http, $location, $modal) {
      ...
      sampleService.isAdvancedSearch = false;
      ...
      $scope.goToSample = function (type, id) {
        if (type == 'edit') {
          $location.path("/editSample").search({
            'sampleId': id
          }).replace();
        } else {
      ...
      $scope.exportJsonAll = function () {
        ...
        postObject.sampleIds = utilsService.sampleIdListStrings($scope.sampleData); //$scope.sampleData;
          ...
          headers: {
            "Content-Type": "application/json"
                 ...
                 .then(function (data) {
                     ...
                     $scope.error = error;
                     $scope.loader = false;
                     console.error('exportJsonAll error: ', error);
             }).catch(function (err) {
      ...
      $scope.exportXmlAll = function () {
        ...
        then(function (data) {
          ...
          // Use the epoch for unique file name
