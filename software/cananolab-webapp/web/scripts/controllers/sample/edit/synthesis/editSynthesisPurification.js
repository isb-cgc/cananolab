...
// Finding section code //    
    ...
    $scope.updateColumnOrder = function () {
      ...
      $http({ method: 'POST', url: '/caNanoLab/rest/synthesisPurification/setColumnOrder', data: $scope.currentFinding }).
        success(function (data, status, headers, config) {
          $scope.loader = false;
          $scope.currentFinding = data;
          $scope.columnOrder = 0;
    ...
    $scope.removeFile = function (fileId) {
      if (confirm("Are you sure you want to delete the File?")) {
        ...
        $http({ method: 'POST', url: '/caNanoLab/rest/synthesisPurification/removeFile', data: $scope.currentFinding }).
          success(function (data, status, headers, config) {
            $scope.currentFinding = data;
    ...
    $scope.saveFileData = function () {
      ...
      $scope.messages = [];
      $http({ method: 'POST', url: '/caNanoLab/rest/synthesisPurification/saveFile', data: $scope.currentFinding }).
        success(function (data, status, headers, config) {
          $scope.currentFinding = data;
          $scope.addNewFile = false;
          $scope.loader = false;
