...
describe("editUser spec ", function () {
    ...
    var $scope = {},
        controller, rootscope, http, httpBackend, location, timeout, route_params, upload, navigation_service, group_service, editUserCtrl, mockUserResource;
    ...
    var read = {
        ...
        "title": null,
        "phoneNumber": null,
        "password": "$2a$10$EmfHzgyCiGdkNM6oM2jtEeMstTcNhM9pvsskD2fhy9cupEouWl3uq",
        "emailId": "ttran@nih.gov",
        "enabled": true,
        "roles": ["ROLE_ANONYMOUS", "ROLE_RESEARCHER"],
        "groups": ["test_group", "test group", "a new test", "Group A", "Group B", "TEST 1", "TEST 2"],
        "authorities": [{
            "authority": "test_group"
        }, {
            "authority": "test group"
        }, {
            "authority": "a new test"
        }, {
            "authority": "Group A"
        }, {
            "authority": "Group B"
