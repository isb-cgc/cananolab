 ...
 *
 */
public class PurificationConfigBean {
	private PurificationConfig domain = new PurificationConfig();
	...
	public PurificationConfigBean(PurificationConfig config) {
		domain = config;
	...
	public PurificationConfig getDomain() {
		return domain;
	}
	...
	public void setupDomain(String createdBy) throws Exception {
		if (domain.getPurificationConfigPkId() != null && domain.getPurificationConfigPkId() == 0) {
			domain.setPurificationConfigPkId(null);
		}
		// updated created_date and created_by if id is null
		if (domain.getPurificationConfigPkId() == null) {
	...
	public boolean equals(Object obj) {
		boolean eq = false;
		if (obj instanceof PurificationConfigBean) {
			PurificationConfigBean c = (PurificationConfigBean) obj;
			Long thisId = this.domain.getPurificationConfigPkId();
			if (thisId != null && thisId.equals(c.getDomain().getPurificationConfigPkId())) {
				eq = true;
			}
		}
		return eq;
	...
	public void resetDomainCopy(String createdBy, PurificationConfig copy) {
		copy.setPurificationConfigPkId(null);
