...
public class CoreServicesTest {
	...
	public void setUp() {
		...
		specification = new RequestSpecBuilder()
				...
				.setBaseUri(RestTestLoginUtil.readTestUrlProperty() +  "/rest/core/")
...
//						.when().get(RestTestLoginUtil.readTestUrlProperty() +  "/rest/core/getFavorites");
...
//				.when().post(RestTestLoginUtil.readTestUrlProperty() +  "/rest/core/addFavorite");
