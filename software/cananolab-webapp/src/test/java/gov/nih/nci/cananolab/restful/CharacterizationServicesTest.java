	...
	public void testSetupEdit() {
		...
		Response res =
				...
				.body("type", hasItems("physico-chemical characterization",
						...
						"ex vivo"))
						.when().get(RestTestLoginUtil.readTestUrlProperty() + "/rest/characterization/setupEdit");
	...
	public void testSetupAdd() {
		...
		Response res =
				...
				.body("charTypesLookup", hasItems("physico-chemical characterization",
						"in vitro characterization",
						"ex vivo"))
						.when().get(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/setupAdd");
...
// RestTestLoginUtil.readTestUrlProperty() +  "characterization.do?dispatch=setupUpdate&sampleId=69500928&charId=69599238&charClassName=MolecularWeight&charType=physico-chemical%20characterization
		...
		Response res =
				...
				.body("assayType", equalTo("molecular weight"))
						.when().get(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/setupUpdate");
	...
	public void testGetCharNamesByCharType() {
		...
		Response res =
				...
				.when().get(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/getCharNamesByCharType");
	...
	public void testGetAssayTypesByCharName() {
		...
		Response res =
				...
				.when().get(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/getAssayTypesByCharName");
	...
	public void testSaveExperimentConfigAdd() {
		...
		.expect().body("charTypesLookup", hasItems("physico-chemical characterization",
				"in vitro characterization",
				"ex vivo"))
		.when().post(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/saveExperimentConfig");
...
//		insts.add(inst);
		...
		.expect().body("charTypesLookup", hasItems("physico-chemical characterization",
				"in vitro characterization",
				"ex vivo"))
		.when().post(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/removeExperimentConfig");
	...
	public void testGetInstrumentTypesByTechniqueType() {
		Response res =
				...
				.when().get(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/getInstrumentTypesByTechniqueType");
	...
	public void testGetColumnNameOptionsDatum() {
		...
		Response res =
				...
				.body("", hasItems("PDI", "other"))
						.when().get(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/getColumnNameOptionsByType");
	...
	public void testGetColumnValueUnitOptions() {
		...
		Response res =
				...
				.expect()
				.body("", hasItems("day"))
						.when().get(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/getColumnValueUnitOptions");
	...
	public void testGetConditionPropertyOptions() {
		...
		Response res =
				...
				.expect()
				.body("", hasItems("time"))
						.when().get(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/getConditionPropertyOptions");
...
//           }
		...
		.expect().body("charTypesLookup", hasItems("physico-chemical characterization",
				"in vitro characterization",
				"ex vivo"))
		.when().post(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/removeFinding");
	...
	public void testDelete() {
		...
		.when().post(RestTestLoginUtil.readTestUrlProperty() +  "/rest/characterization/removedCharacterization");
