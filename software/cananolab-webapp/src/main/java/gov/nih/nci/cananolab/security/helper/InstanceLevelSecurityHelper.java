...
//		}
	 ...
	 */
	public static List<FilterDefinition> getFiltersForGroups(AuthorizationManager authorizationManager) throws  Exception
	{
...
//		}	
	 ...
	 */
	public static List<FilterDefinition> getFiltersForUser(AuthorizationManager authorizationManager) throws  Exception
	{
		Properties props = new Properties();
		ApplicationContext ac = authorizationManager.getApplicationContext();
		props.setProperty("hibernate.connection.url", ac.getDatabaseURL());
