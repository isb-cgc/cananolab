...
public class GCPStorageUtil {
    ...
    public static String getGCPStorageBucketPath() {
        ...
        logger.info("GCPStorageUtil get bucket path: " + bucketPath);
    ...
    private static void printAllSystemVars() {
        for (Map.Entry<String,String> entry : System.getenv().entrySet()) {
            logger.info(String.format("GCPStorageUtil SysVar Key: %s, Value: %s", entry.getKey(), entry.getValue()));
        }
    }
    ...
    public static String getGCPStorageRootFolderPath() {
        ...
        logger.info("GCPStorageUtil get folder path: " + folderPath);
